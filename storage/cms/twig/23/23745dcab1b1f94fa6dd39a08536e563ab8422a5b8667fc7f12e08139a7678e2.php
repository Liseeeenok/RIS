...
<form class=\"ui form\"
    ...
    <div class=\"fields\">
        <div class=\"field\">
            ...
            <input name=\"art-wos-q1\" type=\"number\" value=\"4\" min=\"0\" max=\"10\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Статьи Wos Q2</label>
            <input name=\"art-wos-q2\" type=\"number\" value=\"2\" min=\"0\" max=\"10\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Статьи Wos Q3</label>
            <input name=\"art-wos-q3\" type=\"number\" value=\"2\" min=\"0\" max=\"10\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Статьи Wos Q4</label>
            <input name=\"art-wos-q4\" type=\"number\" value=\"2\" min=\"0\" max=\"10\" step=\"0.05\">
        </div>
    </div>
    <div class=\"fields\">        
        <div class=\"field\">
            <label>Статьи Wos ESCI</label>
            <input name=\"art-wos-q5\" type=\"number\" value=\"1.2\" min=\"0\" max=\"10\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Статьи Scopus</label>
            <input name=\"art-scopus\" type=\"number\" value=\"1.2\" min=\"0\" max=\"10\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Статьи РИНЦ</label>
            <input name=\"art-risc\" type=\"number\" value=\"0.6\" min=\"0\" max=\"10\" step=\"0.05\">
        </div>
    </div>
    <div class=\"fields\">
        <div class=\"three field\">
            <label>Труды Wos</label>
            <input name=\"proc-wos\" type=\"number\" value=\"0.6\" min=\"0\" max=\"100\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Труды Scopus</label>
            <input name=\"proc-scopus\" type=\"number\" value=\"0.5\" min=\"0\" max=\"100\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Труды РИНЦ</label>
            <input name=\"proc-risc\" type=\"number\" value=\"0.2\" min=\"0\" max=\"100\" step=\"0.05\">
        </div>
    </div>
    <div class=\"fields\">
        <div class=\"field\">
            <label>Монографии</label>
            <input name=\"books\" type=\"number\" value=\"8\" min=\"0\" max=\"100\" step=\"0.05\">
        </div>
        <div class=\"field\">
            <label>Свидетельства о регистрации</label>
            <input name=\"patents\" type=\"number\" value=\"0.4\" min=\"0\" max=\"100\" step=\"0.05\">
        </div>
    </div>
    <div class=\"field\">
...
";
    ...
    {
        return array (  87 => 30,  78 => 26,  70 => 21,  66 => 20,  62 => 18,  60 => 17,  57 => 16,  55 => 3,  42 => 4,  40 => 3,  37 => 2,);
    }
...
<form class=\"ui form\"
    data-request=\"{{ __SELF__ }}::onLoadReport\"
    data-request-update=\"'{{ __SELF__ }}::raspil-list-by-departments': '#result'\">
    <h4 class=\"ui dividing header\">Общая информация</h4>    
    <div class=\"fields\">
        <div class=\"field\">
            <label>Первый отчетный год</label>
            <input name=\"year[from]\" type=\"number\" value=\"{{ nowYear - 1 }}\" min=\"1990\" max=\"{{ nowYear }}\" tabindex=\"0\">
        </div>
        <div class=\"field\">
            <label>Последний отчетный год</label>
